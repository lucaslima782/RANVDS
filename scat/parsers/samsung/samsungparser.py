...
class SamsungParser:
    ...
    def __init__(self):
        ...
        self.nr_last_cell_id = 0
        self.nr_last_pci = 0
        self.nr_last_nrarfcn_dl = 0
        self.nr_last_nrarfcn_ul = 0
        self.nr_last_nrarfcn_tdd = 0
        self.nr_last_sfn = 0
        self.nr_last_tx_ant = 0
        self.nr_last_bw_dl = 0
        self.nr_last_bw_ul = 0
        self.nr_last_band_ind = 0
